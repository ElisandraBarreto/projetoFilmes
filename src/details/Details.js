    ...
    return (
        <Container>
            ...
            <div className="trailer">
                ...
                <iframe width="460" height="315" src={trailer.key} title={trailer.name} class="embed hide" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; picture-in-picture">
                </iframe>
